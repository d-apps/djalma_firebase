 String getFirebaseErrorMessage(String e){

   String message;

   if(e.contains("ERROR_USER_NOT_FOUND")){
   ...
   } else if (e.contains("ERROR_WEAK_PASSWORD")) {
   ...
   } else if (e.contains("There is no user record corresponding to this identifier. The user may have been deleted. (auth/user-not-found)")) {
